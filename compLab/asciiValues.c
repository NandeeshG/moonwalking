...
int main()
{
    ...
    printf("Prints all character ascii values from ! to ~ \n\n");
...
D:\Documents\Programming\online\moonwalking\compLab>gcc asciiValues.c

D:\Documents\Programming\online\moonwalking\compLab>a.exe
Enter your name- ng
Hi ng. This program
Prints all character ascii values from ! to ~
